...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-[#202529] sm:py-2 animate-blurred-fade-in">
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-gray-900 text-white' : 'text-[#FEFEFE] hover:bg-gray-700 hover:text-white',
